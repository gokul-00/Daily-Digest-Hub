...
var DEFAULT_HEADERS = { "X-Client-Info": `storage-js/2.108.1` };
...
function serializeCookieHeader(name, value, options) {
	return import_dist.serialize(name, value, options);
}
function isBrowser() {
...
//#endregion
export { createClient as a, serializeCookieHeader as i, createBrowserClient as n, parseCookieHeader as r, createServerClient as t };
