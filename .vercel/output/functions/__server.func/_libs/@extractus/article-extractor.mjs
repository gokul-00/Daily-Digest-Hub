...
var require_decode$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var decode_data_html_js_1 = __importDefault(require_decode_data_html$1());
	exports.htmlDecodeTree = decode_data_html_js_1.default;
	var decode_data_xml_js_1 = __importDefault(require_decode_data_xml$1());
	exports.xmlDecodeTree = decode_data_xml_js_1.default;
	var decode_codepoint_js_1 = __importStar(require_decode_codepoint$1());
...
//#endregion
//#region node_modules/entities/lib/generated/encode-html.js
...
//#endregion
//#region node_modules/entities/lib/escape.js
...
var require_lib$3 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var decode_js_1 = require_decode$1();
	...
	*/
	...
	var decode_js_2 = require_decode$1();
...
//#endregion
//#region node_modules/htmlparser2/node_modules/entities/dist/commonjs/decode-codepoint.js
...
//#endregion
//#region node_modules/htmlparser2/node_modules/entities/dist/commonjs/internal/decode-shared.js
...
//#endregion
//#region node_modules/htmlparser2/node_modules/entities/dist/commonjs/generated/decode-data-html.js
...
//#endregion
//#region node_modules/htmlparser2/node_modules/entities/dist/commonjs/generated/decode-data-xml.js
...
//#endregion
//#region node_modules/htmlparser2/node_modules/entities/dist/commonjs/internal/bin-trie-flags.js
...
//#endregion
//#region node_modules/htmlparser2/node_modules/entities/dist/commonjs/decode.js
...
//#endregion
//#region node_modules/htmlparser2/dist/commonjs/Tokenizer.js
...
//#endregion
//#region node_modules/htmlparser2/dist/commonjs/Parser.js
...
//#endregion
//#region node_modules/htmlparser2/dist/commonjs/index.js
...
function stringifyToken(token, index, arr) {
	switch (token.type) {
		...
		case SelectorType.Attribute: {
			...
			if (token.action === AttributeAction.Exists) return `[${name}]`;
...
//#endregion
//#region node_modules/@pwshub/bellajs/src/detection.js
/**
...
*/
var isObject = (val) => {
	return {}.toString.call(val) === "[object Object]" && !isArray$1(val);
};
//#endregion
//#region node_modules/@pwshub/bellajs/src/string.js
var toString$1 = (input) => {
...
*/
var truncateByChar = (text, charLimit = 0) => {
	if (!text) return "";
	if (charLimit <= 0) return text;
	const segments = new Intl.Segmenter(void 0, { granularity: "grapheme" }).segment(text);
	let count = 0;
	let result = "";
	for (const { segment } of segments) {
		if (count >= charLimit) return result + "...";
		result += segment;
		count++;
	}
	return result;
...
*/
var stripTags = (s) => {
	return toString$1(s).replace(/(<([^>]+)>)/gi, "").trim();
};
var accentMap = /* @__PURE__ */ new Map();
var buildAccentMap = () => {
	const lmap = {
	...
	for (const key in lmap) lmap[key].split("|").forEach((v) => {
		accentMap.set(v, key);
...
var getWordCount = (text) => {
	if (!text) return 0;
	const segments = new Intl.Segmenter(void 0, { granularity: "word" }).segment(text);
	let wordCount = 0;
	for (const { isWordLike } of segments) if (isWordLike) wordCount++;
	return wordCount;
};
/**
...
*/
var getTTR = (text, imgcount = 0, wordsPerMinute = 268) => {
	const minToRead = getWordCount(text) / wordsPerMinute;
...
globalThis.crypto;
//#endregion
//#region node_modules/@pwshub/bellajs/src/fp.js
/**
...
//#endregion
//#region node_modules/@pwshub/bellajs/src/object.js
/**
...
//#endregion
//#region node_modules/@pwshub/bellajs/src/array.js
/**
...
//#endregion
//#region node_modules/@pwshub/bellajs/src/similarity.js
/**
...
*/
var cosineSimilarity = (bow1, bow2) => {
...
//#endregion
//#region node_modules/@extractus/article-extractor/src/utils/retrieve.js
/**
...
var retrieve_default = async (url, options = {}) => {
	const { headers = { "user-agent": "Mozilla/5.0 (X11; Linux x86_64; rv:109.0) Gecko/20100101 Firefox/115.0" }, proxy = null, agent = null, signal = null } = options;
	...
	if (status >= 400) throw new Error(`Request failed with error code ${status}`);
...
* Text within the document.
*/
var Text$2 = class extends DataNode {
	constructor() {
		super(...arguments);
...
* Comments within the document.
*/
var Comment$2 = class extends DataNode {
	constructor() {
		super(...arguments);
...
function cloneNode(node, recursive = false) {
	let result;
	if (isText(node)) result = new Text$2(node.data);
	else if (isComment(node)) result = new Comment$2(node.data);
...
var DomHandler = class {
	...
	*/
	...
	onopentag(name, attribs) {
		const element = new Element$2(name, attribs, void 0, this.options.xmlMode ? ElementType.Tag : void 0);
		this.addNode(element);
		this.tagStack.push(element);
	}
	ontext(data) {
...
function renderNode(node, options) {
	switch (node.type) {
		...
		case Comment$3: return renderComment(node);
		case CDATA$1: return renderCdata(node);
		case Script:
		case Style:
		case Tag: return renderTag(node, options);
		case Text$3: return renderText(node, options);
	}
}
var foreignModeIntegrationPoints = new Set([
	"mi",
...
function compileUnsafe(selector, options, context) {
	return compileToken(typeof selector === "string" ? parse$3(selector) : selector, options, context);
}
...
var require_CSSStyleSheet = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	*/
	...
	CSSOM.parse = require_parse$1().parse;
}));
//#endregion
...
var require_previous_map = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var { dirname: dirname$1, join } = __require("path");
...
//#endregion
//#region node_modules/@extractus/article-extractor/src/config.js
...
//#endregion
//#region node_modules/@extractus/article-extractor/src/utils/html.js
/**
...
var cleanify = (inputHtml) => {
	const html = new DOMParser().parseFromString(inputHtml, "text/html").documentElement.innerHTML;
	return pipe((input) => (0, import_sanitize_html.default)(input, getSanitizeHtmlOptions()), (input) => stripMultiLinebreaks(input), (input) => stripMultispaces(input))(html);
};
/**
...
*/
var countImages = (html) => {
	return (new DOMParser().parseFromString(html, "text/html").querySelectorAll("img") || []).length;
};
//#endregion
//#region node_modules/@extractus/article-extractor/src/utils/similarity.js
/**
...
var areArgsValid = (mainString, targetStrings) => {
	return isString(mainString) && isArray$1(targetStrings) && targetStrings.length > 0 && targetStrings.every((s) => isString(s));
};
/**
...
//#endregion
//#region node_modules/@extractus/article-extractor/src/utils/linker.js
/**
...
var chooseBestUrl = (candidates = [], title = "") => {
	return findBestMatch(title, candidates).bestMatch.target;
};
/**
...
var normalize = (html, url) => {
	...
	Array.from(doc.getElementsByTagName("img")).forEach((element) => {
		...
		if (src) element.setAttribute("src", absolutify(url, src));
	});
...
//#endregion
//#region node_modules/@extractus/article-extractor/src/utils/extractLdSchema.js
/**
...
var isAllowedLdJsonType = (ldJson) => {
	...
	const ldJsonTypes = (isArray$1(rootLdJsonType) ? rootLdJsonType : [rootLdJsonType]).filter((x) => !!x);
...
var extractLdSchema_default = (document, entry) => {
	document.querySelectorAll("script[type=\"application/ld+json\"]").forEach((ldSchema) => {
		const ldJson = parseJson(ldSchema.textContent.replace(/[\n\r\t]/g, ""));
		if (ldJson && isAllowedLdJsonType(ldJson)) for (const [key, attr] of Object.entries(attributeLists)) {
			if (!entry[key] || !ldJson[attr]) continue;
			const keyValue = ldJson[attr];
			const val = isArray$1(keyValue) ? keyValue[0] : isObject(keyValue) ? keyValue?.name || "" : keyValue;
			if (isString(val) && val !== "") entry[key] = val.trim();
		}
	});
	return entry;
};
//#endregion
//#region node_modules/@extractus/article-extractor/src/utils/findDate.js
/**
...
function convertDateFormat(dateString) {
	...
	let year, month, day;
	if (parts[0].length === 4 || parseInt(parts[0]) > 31) [year, month, day] = parts;
	else if (parseInt(parts[0]) > 12) [day, month, year] = parts;
...
//#endregion
//#region node_modules/@extractus/article-extractor/src/utils/extractMetaData.js
/**
* @param {Element} node
...
function getMetaContentByNameOrProperty(node, attributeLists) {
	...
	for (const [key, attrs] of Object.entries(attributeLists)) if (attrs.includes(property) || attrs.includes(name)) return {
		key,
		content
	};
	return null;
...
var extractMetaData_default = (html) => {
	...
	Array.from(doc.getElementsByTagName("link")).forEach((node) => {
		...
		if (rel && href) {
			entry[rel] = href;
			if (rel === "icon" || rel === "shortcut icon") entry.favicon = href;
		}
	});
	Array.from(doc.getElementsByTagName("meta")).forEach((node) => {
		...
		if (val !== "") entry[result.key] = val;
	});
	const metadata = extractLdSchema_default(doc, entry);
	if (!metadata.published) metadata.published = findDate_default(doc) || "";
	return metadata;
};
//#endregion
...
//#endregion
//#region node_modules/@extractus/article-extractor/src/utils/extractWithReadability.js
...
var extractWithReadability_default = (html, url = "") => {
	...
	const result = new import_readability.Readability(doc, { keepClasses: true }).parse() ?? {};
...
function extractTitleWithReadability(html) {
	if (!isString(html)) return null;
	return new import_readability.Readability(new DOMParser().parseFromString(html, "text/html"))._getArticleTitle() || null;
}
//#endregion
//#region node_modules/@extractus/article-extractor/src/utils/transformation.js
/**
...
var findTransformations = (links) => {
	const urls = !isArray$1(links) ? [links] : links;
	const tfms = [];
	for (const transformation of transformations) {
		const { patterns } = transformation;
		if (urls.some((url) => patterns.some((pattern) => pattern.test(url)))) tfms.push({ ...transformation });
	}
	return tfms;
};
/**
...
//#endregion
//#region node_modules/@extractus/article-extractor/src/utils/parseFromHtml.js
/**
...
*/
var summarize = ({ desc, text, threshold, maxlen }) => {
	return desc.length > threshold ? desc : truncateByChar(text, maxlen).replace(/\n/g, " ");
};
/**
...
var parseFromHtml_default = async (inputHtml, inputUrl = "", parserOptions = {}) => {
	...
	if (!title) title = extractTitleWithReadability(pureHtml, inputUrl);
	...
	const links = unique([
		...
		canonical,
		inputUrl
	].filter(isValid).map(purify));
	if (!links.length) return null;
	const bestUrl = chooseBestUrl(links, title);
	const content = pipe((input) => {
	...
	if (textContent.length < contentLengthThreshold) return null;
...
//#endregion
//#region node_modules/@extractus/article-extractor/src/main.js
/**
...
var extract = async (input, parserOptions = {}, fetchOptions = {}) => {
	...
	if (!isValid(input)) return parseFromHtml_default(input, null, parserOptions);
	...
	return parseFromHtml_default(new TextDecoder(charset).decode(buffer), input, parserOptions);
};
//#endregion
export { require_commonjs as a, require_lib$4 as c, init_es as i, require_cjs as l, require_boolbase as n, require_lib$1 as o, es_exports as r, require_lib$2 as s, extract as t };
