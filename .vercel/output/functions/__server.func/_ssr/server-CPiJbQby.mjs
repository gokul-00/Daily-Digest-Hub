...
import { n as getResponse, r as requestHandler } from "./request-response-B3cB1PJw.mjs";
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-HxA0r44m.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-GRAVQoDx.mjs");
